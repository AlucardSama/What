...
public class CaijingNewsFragment extends BaseFragment {
    ...
    private static CaijingNewsFragment fragment;


    public static CaijingNewsFragment newInstance() {
        if (fragment == null) {
             fragment = new CaijingNewsFragment();
        }
        return fragment;
    }
    ...
    public void onVisibleToUser() {
        ...
        rx.Observable<NewsList> githubBeanObservable=newsService.getNewsList("caijing", Constants.KEY);
