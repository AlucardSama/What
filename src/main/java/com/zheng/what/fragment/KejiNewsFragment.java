 ...
 */
public class KejiNewsFragment extends BaseFragment {

    private static KejiNewsFragment fragment;


    public static KejiNewsFragment newInstance() {
        if (fragment == null) {
            fragment = new KejiNewsFragment();
        }
        return fragment;
    }
    ...
    public void onVisibleToUser() {
        ...
        rx.Observable<NewsList> githubBeanObservable = newsService.getNewsList("keji", Constants.KEY);
