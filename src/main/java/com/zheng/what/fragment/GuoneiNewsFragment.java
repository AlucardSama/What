 ...
 */
public class GuoneiNewsFragment extends BaseFragment {

    private static GuoneiNewsFragment fragment;


    public static GuoneiNewsFragment newInstance() {
        if (fragment == null) {
            fragment = new GuoneiNewsFragment();
        }
        return fragment;
    }
    ...
    public void onVisibleToUser() {
        ...
        rx.Observable<NewsList> githubBeanObservable = newsService.getNewsList("guonei", Constants.KEY);
