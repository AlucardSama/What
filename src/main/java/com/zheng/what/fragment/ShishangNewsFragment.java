 ...
 */
public class ShishangNewsFragment extends BaseFragment {

    private static ShishangNewsFragment fragment;


    public static ShishangNewsFragment newInstance() {
        if (fragment == null) {
            fragment = new ShishangNewsFragment();
        }
        return fragment;
    }
    ...
    public void onVisibleToUser() {
        ...
        rx.Observable<NewsList> githubBeanObservable = newsService.getNewsList("shishang", Constants.KEY);
