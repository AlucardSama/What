...
public class TiyuNewsFragment extends BaseFragment {
    ...
    private static TiyuNewsFragment fragment;


    public static TiyuNewsFragment newInstance() {
        if (fragment == null) {
            fragment = new TiyuNewsFragment();
        }
        return fragment;
    }
    ...
    public void onVisibleToUser() {
        ...
        rx.Observable<NewsList> githubBeanObservable = newsService.getNewsList("tiyu", Constants.KEY);
