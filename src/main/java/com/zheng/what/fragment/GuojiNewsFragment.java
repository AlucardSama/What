 ...
 */
public class GuojiNewsFragment extends BaseFragment {

    private static GuojiNewsFragment fragment;


    public static GuojiNewsFragment newInstance() {
        if (fragment == null) {
             fragment = new GuojiNewsFragment();
        }
        return fragment;
    }
    ...
    public void onVisibleToUser() {
        ...
        rx.Observable<NewsList> githubBeanObservable=newsService.getNewsList("guoji", Constants.KEY);
