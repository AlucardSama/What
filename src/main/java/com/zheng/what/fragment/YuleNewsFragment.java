...
public class YuleNewsFragment extends BaseFragment {
    ...
    private static YuleNewsFragment fragment;


    public static YuleNewsFragment newInstance() {
        if (fragment == null) {
            fragment = new YuleNewsFragment();
        }
        return fragment;
    }
    ...
    public void onVisibleToUser() {
        ...
        rx.Observable<NewsList> githubBeanObservable = newsService.getNewsList("yule", Constants.KEY);
