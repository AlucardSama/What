 ...
 */
public class JunshiNewsFragment extends BaseFragment {

    private static JunshiNewsFragment fragment;


    public static JunshiNewsFragment newInstance() {
        if (fragment == null) {
            fragment = new JunshiNewsFragment();
        }
        return fragment;
    }
    ...
    public void onVisibleToUser() {
        ...
        rx.Observable<NewsList> githubBeanObservable = newsService.getNewsList("junshi", Constants.KEY);
